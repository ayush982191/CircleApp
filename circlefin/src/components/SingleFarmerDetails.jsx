...
const SingleFarmerDetails = () => {
  ...
  const { name, creditScore, Experience, crops, OverallRating, financialHealth, Tenure, State, image, "Amount-Required": amountRequired, "Risk Factor": riskFactor } = farmer;
        ...
        <div>
          <div className='w-[35rem]'>
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm font-medium text-lime-700 dark:text-white">{randomNumber}% Collected</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
              <div className="bg-lime-600 h-2.5 rounded-full" style={{ width: `${randomNumber}%` }}></div>
            </div>
          </div>
          <div className='mt-10'>
