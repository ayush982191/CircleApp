  ...
  return (
    <div className='z-20 mt-5 fixed top-0 left-0 right-0 bg-lime-600 p-3 mx-16 rounded-xl flex items-center justify-between'>
      ...
      <div className='mr-5'>
        <ul className='flex'>
          <li>
            <Link className='p-5 text-gray-200 font-bold  bg-lime-500 hover:bg-lime-500 transition duration-700' to="/">Home</Link>
          </li>
          <li>
            <Link className='p-5 text-gray-200 font-bold  hover:bg-lime-500 transition duration-700' to="/portfolio">Portfolio</Link>
          </li>
          <li>
