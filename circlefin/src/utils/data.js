...
import geopgraphyIcon from "../assets/CarouselLogo/geopgraphyIcon.jpg";
...
import merchantTechnology from "../assets/CarouselLogo/merchantTechnology.png"
import merchantType from "../assets/CarouselLogo/merchantType.webp";
import primarygoods from "../assets/CarouselLogo/primarygoods.jpg";
...
export const merchantFilter = [
  ...
  { id: 'type-of-merchant', label: 'Merchant Type', subOptions: ['Cash Crop Trader', 'Lentils Trader'] },
  { id: 'business-size', label: 'Business Size', subOptions: ['revenue below $1 crore', 'revenue above $1 crore'] },
  { id: 'primary-goods-traded', label: 'Primary Goods Traded', subOptions: ['Non-Perishable Goods', 'Perishable Goods'] },
  { id: 'use-of-technology', label: 'Use of Technology', subOptions: ['Modern (E-commerce, ONDC Platform, Digital Payments)', 'Traditional'] },
...
export const merchantProfiles = [
  {
    ...
    // "ASSESSMENT SUMMARY"
   " CREDIT SCORE": "680 (B)",
    // Amit Verma has a fair credit score, indicating a moderate credit history with some room for improvement in repayment behavior.
    ...
    "REPAYMENT STRUCTURE" : "Monthly installments over 3 years with seasonal adjustments  Taking into account the seasonal nature of cash crop trading, repayment should accommodate fluctuating income streams.",
    "Overall Rating": "B+",
   " Recommendation" :" Amit Verma is eligible for a $1,10,000 loan with a structured monthly repayment plan that considers seasonal income variations. Suggested investments include modernizing inventory management systems and enhancing supply chain operations to increase efficiency and reduce market risks. Additionally, adopting more sustainable practices could improve long-term viability and market appeal.",
    ...
    'Lentils Trader' : true,
    'revenue below $1 crore' : false,
    'revenue above $1 crore' : true,
  ...
  },
  {
    ...
    "Cash Crop Trader": false,
    "Lentils Trader": true,
    "revenue below $1 crore": true,
    "revenue above $1 crore": false,
    "Non-Perishable Goods": false,
    "Perishable Goods": true,
    "Modern (E-commerce, ONDC Platform, Digital Payments)": false,
    "Traditional": true,
  ...
  },
  {
    ...
    "Amount Required": 2500000,
    "amountReceived" : 800000,
    "Annual Revenue": 2700000,
    "North India": false,
    "South India": true,
    "East India": false,
    "West India": false,
  ...
  },
  {
    ...
    "name": "Rahul",
    "state": "Tamil Nadu",
    "Amount Required": 220000,
    "Annual Revenue": 21000,
    "North India": false,
    "South India": true,
    "East India": false,
    "West India": false,
  ...
  },
  {
    ...
    "name": "Vivek",
    "state": "Goa",
    "Amount Required": 180000,
    "amountReceived" : 100000,
    "Annual Revenue": 2300000,
    "North India": false,
    "South India": false,
    "East India": false,
    "West India": true,
...
export const merchantCarouselLogoArray = [geopgraphyIcon,merchantType,farmSize,primarygoods,merchantTechnology,revenue,loanAmount]
